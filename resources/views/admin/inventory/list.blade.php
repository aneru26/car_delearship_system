...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Inventory (Total : {{ $getRecord->total() }})</h1>
          </div>
  ...
  <div class="btn-group">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="{{ url('admin/inventory/accept/'.$value->id) }}">Accept</a>
      <a class="dropdown-item" href="{{ url('admin/inventory/decline/'.$value->id) }}">Decline</a>
      <a class="dropdown-item" href="{{ url('admin/inventory/delete/'.$value->id) }}">Delete</a>
    </div>
  </div>
</td>
