        ...
        <div class="col-md-6 text-center mb-5">
            ...
            @include(' _message')
                ...
                <div class="w-50 text-md-right">
									<a href="{{ url('register')}}" style="display: inline-block; font-weight:bold; margin-top: 20px; padding: 10px 30px; background-color: rgb(255, 255, 255); color: #000000; border-radius: 20px; text-decoration: none;">Register</a>
								</div>
