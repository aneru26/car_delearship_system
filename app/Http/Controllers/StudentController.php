...
class StudentController extends Controller
{
    ...
    return redirect($redirectPath)->with('succes', "Faculty Successfully Added");
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect($redirectPath)->with('succes', "Faculty successfully Updated");
    ...
    public function delete($id)
    {
        ...
        if(!empty($getRecord))
        {
            ...
            return redirect()->back()->with('succes',"Faculty successfully Deleted");
        }
        else
        {
            abort(404);
